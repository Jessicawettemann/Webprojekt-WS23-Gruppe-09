        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($searchStatement->rowCount() > 0) {
                ...
                if ($checkStatement->rowCount() == 0) {
                    ...
                    echo "<button type='submit' class='follow-button'>Follow</button>";
                } else {
                    // Der Benutzer folgt bereits, zeige den Unfollow-Button
                    echo "<button type='submit' formaction='unfollow.php' class='follow-button'>Unfollow</button>";
                }
    ...
    if ($statementBeitrag->rowCount() > 0) {
        ...
        foreach ($statementBeitrag as $row) {
            ...
            if (!empty($profilbildRow['profilbild'])) {
                ...
                echo "<img class='profilpicture' src='https://mars.iuk.hdm-stuttgart.de/~jw170/Bilder/" . $profilbildRow['profilbild'] . "'></div>";
            } else {
