...
if ($benutzername2){
    die ("<div class='fail'>Der Nutzername existiert bereits, bitte wähle einen anderen.</div>"."</p> <a href= 'benutzername_do.php'> Profil bearbeiten</a>");
}else{
...
if($statement->execute()){
    ...
    echo '<p>'. "<div class='fail'>Beim Bearbeiten ist etwas schiefgelaufen, bitte versuche es erneut</div>.". "</p> <a href= 'benutzername bearbeiten_do.php'> Benutzername bearbeiten</a>";
}
?>
